 ...
 */
public class
DrawPoint extends Component implements Component.DrawTask {
    ...
    public void onDraw(Component component, Canvas canvas) {
        ...
        if (pointXs != null && pointXs.length > 1) {
            for (int i = 0; i < pointXs.length; i++) {
                ...
                remotePoints.add(new com.example.drawguess.point.MyPoint(finalX, finalY, isLast));
            }
    ...
    public interface OnDrawCallBack {
         ...
         * @param points List
         */
        void callBack(List<com.example.drawguess.point.MyPoint> points);
    }
}
